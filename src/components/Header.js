  ...
  return (
    ...
    <a href="" className="bg-black-80 ba b--black dib pa3 w2 h2 br-100">
      ...
      <nav className="bt bb tc mw7 center mt4">
        ...
        <a className="f6 f5-l link bg-animate black-80 hover-bg-light-green dib pa3 ph4-l" href="#section1">Portfolio</a>
        <a className="f6 f5-l link bg-animate black-80 hover-bg-light-blue dib pa3 ph4-l" href="#section2">Shop</a>
